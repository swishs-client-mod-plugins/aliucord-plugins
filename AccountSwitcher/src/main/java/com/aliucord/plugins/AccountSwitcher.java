...
public class AccountSwitcher extends Plugin {
    ...
    public Manifest getManifest() {
        ...
        manifest.description = "Lets you switch between multiple accounts via chat commands.";
        manifest.version = "1.0.0";
        manifest.updateUrl = "https://raw.githubusercontent.com/Juby210/Aliucord-plugins/builds/updater.json"; // change
        return manifest;
    }
